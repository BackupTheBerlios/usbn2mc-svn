...
\item [usbprog]
	\begin{itemize}
	\item Frei programmierbarer USB Adapter (AVRISP mkII Klon, ISP, RS232, JTAG,...)
	\item http://www.embedded-projects.net/usbprog
	\end{itemize}
\item [vPort]
	\begin{itemize}
	\item vPort Schnittstellen Wandler und I/O Erweiterung für den PC 
...
\item [Netzwerkkarte mit TCP/IP Stack] 
  \begin{itemize}
	\item Kommunikation mit einem USB Ger"at "uber Sockets
	\item http://www.ixbat.de/index.php?page_id=97
	\item Realsierung als Communication Device Class
	\item Integrierter uIP TCP/IP Stack
	\end{itemize}

\item [PS2 zu USB Wandler (HID)]
	\begin{itemize}
	\item Ein PS/2 (Tastatur) zu USB Wandler mit usbn2mc
	\item http://www.ixbat.de/index.php?page_id=98
	\end{itemize}

\item [Logik Analysator]
	\begin{itemize}
	\item USB Logik Analysator für unter 15 EUR 
	\item http://www.ixbat.de/index.php?page_id=92 
	\end{itemize}

\item [AVR USB Bootloader]
	\begin{itemize}
	\item http://www.ixbat.de/index.php?page_id=81 
	\end{itemize}
